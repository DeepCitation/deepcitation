...
var DC_PROMPTS = {
  ...
  "quick": [
    ...
    "  import { CitationComponent, CitationDrawer } from 'deepcitation/react';",
  ...
  "nextjs": [
    ...
    "  Either side:  parseCitation, getCitationKey  (import from 'deepcitation')",
    "",
    "DO NOT:",
  ...
  "vercel": [
    ...
    "  - Parse <cite .../> tags using parseCitation() + getCitationKey() from 'deepcitation'",
    "",
    "DO NOT:",
  ...
  "claudemd": [
    ...
    "- parseCitation, getCitationKey: either side (pure functions, import from 'deepcitation')",
