...
export async function POST(req) {
    ...
    try {
        ...
        const result = await deepcitation.verify({ llmOutput, outputImageFormat: "avif" }, citations);
        ...
        if (error instanceof ValidationError && error.statusCode === 404) {
            ...
            clearCorpusCache();
            return NextResponse.json({ error: "Documents expired. Please ask your question again.", code: "ATTACHMENT_EXPIRED" }, { status: 410 });
        }
