...
import { DeepCitation, extractVisibleText, getAllCitationsFromLlmOutput, getCitationStatus, getVerificationTextIndicator, replaceCitationMarkers, wrapCitationPrompt, } from "deepcitation";
...
async function main() {
    ...
    // Ask about fast mode
    const fastModeInput = await prompt("Use unsafe fast mode? (y/N) [Fast but vulnerable to hidden text/prompt injection]: ");
