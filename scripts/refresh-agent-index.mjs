...
const DESCRIPTIONS = {
  ...
  "src/cli": "CLI pipeline utilities: markdown-to-HTML converter for --markdown verify reports",
  "src/docs": "Centralized code snippets for INTEGRATION.md",
  "src/formatting": "Citation indicators and formatting utilities (getIndicator, toSuperscript)",
