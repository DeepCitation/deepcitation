...
describe("StatusHeader", () => {
    ...
    describe("page location display", () => {
        ...
        it("shows single page for found_on_other_line (same page)", () => {
            const { container } = render(<StatusHeader status="found_on_other_line" foundPage={5} expectedPage={5}/>);
    ...
    describe("combined header with sourceMatch and sourceContext", () => {
        ...
        it("shows arrow format page badge for partial match", () => {
            const { container } = render(<StatusHeader status="found_on_other_page" foundPage={7} expectedPage={5} sourceMatch="test anchor"/>);
