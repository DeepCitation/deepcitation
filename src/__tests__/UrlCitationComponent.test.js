...
describe("UrlCitationComponent", () => {
    ...
    it("handles missing favicon gracefully", () => {
        const { container } = render(<UrlCitationComponent urlMeta={createUrlMeta({
    ...
    describe("interactions", () => {
        it("opens URL on click by default", () => {
            ...
            expect(windowOpenSpy).toHaveBeenCalledWith("https://stripe.com/docs/api/v2/citations", "_blank", "noopener,noreferrer");
    ...
    describe("display options", () => {
        it("shows title when showTitle is true", () => {
            const { getByText } = render(<UrlCitationComponent urlMeta={createUrlMeta({ title: "Stripe API Documentation" })} showTitle={true}/>);
