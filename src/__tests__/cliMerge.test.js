...
const VALID_A = sectionWithBlock("Section A body with **bold term** [1] and **another** [2] and **third** [3].", JSON.stringify({
    doc1: [
...
const VALID_B = sectionWithBlock("Section B body with **extra** [100] and **more** [101].", JSON.stringify({
    doc1: [
