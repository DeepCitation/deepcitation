...
describe("DeepCitation Client", () => {
    ...
    describe("requestSource", () => {
        it("includes X-Request-Source header when configured", async () => {
            ...
            expect(init.headers["X-Request-Source"]).toBe("my-app");
        });
    ...
    describe("verifyAttachment", () => {
        ...
        it("handles API error gracefully", async () => {
            ...
            await expect(client.verifyAttachment("unknown_file", {
        ...
        it("does not reuse a failed request across different timeouts", async () => {
            ...
            await expect(client.verifyAttachment("file_abc", citations, { requestTimeoutMs: 1 })).rejects.toThrow("Request timed out after 1ms");
    ...
    describe("verifyBatch", () => {
        ...
        it("handles API error in batch mode", async () => {
            ...
            await expect(client.verifyBatch({
        ...
        it("includes endUserId and outputImageFormat in batch request", async () => {
            ...
            await client.verifyBatch({ key1: { type: "document", sourceContext: "test", attachmentId: "abc123", pageNumber: 1 } }, { outputImageFormat: "png", endUserId: "user-batch-1" });
            const requestBody = JSON.parse(mockFetch.mock.calls[0][1].body);
    ...
    describe("getAttachment", () => {
        it("returns attachment metadata on success", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining("/getAttachment"), expect.objectContaining({
                method: "POST",
    ...
    describe("endUserId attribution", () => {
        ...
        it("includes endUserId in verifyAttachment request body", async () => {
            ...
            await client.verifyAttachment("file_abc", { "1": { sourceContext: "test", attachmentId: "file_abc" } }, { endUserId: "user-verify" });
            const requestBody = JSON.parse(mockFetch.mock.calls[0][1].body);
