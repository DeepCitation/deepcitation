...
import { ALLOWED_UPLOAD_MIME_TYPES, MAX_UPLOAD_FILE_SIZE, validateFileMagicBytes, validateUploadFile, } from "../utils/fileSafety";
describe("validateFileMagicBytes", () => {
    ...
    it("rejects WAV file claimed as WebP (RIFF but not WEBP)", () => {
    ...
    it("rejects AVI file claimed as WebP (RIFF but not WEBP)", () => {
