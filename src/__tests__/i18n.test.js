...
import { createTranslator, DeepCitationI18nProvider, defaultMessages, defaultTranslator, tPlural, useTranslation, } from "../react/i18n";
// =============================================================================
// createTranslator
// =============================================================================
describe("createTranslator", () => {
    ...
    it("interpolates {placeholder} values", () => {
        const t = createTranslator();
        expect(t("message.foundOnOtherPage", { actualPage: 5, expectedPage: 3 })).toBe("Found on p.\u202f5 (expected p.\u202f3)");
    });
...
// =============================================================================
function TestConsumer({ msgKey, values }) {
...
describe("DeepCitationI18nProvider", () => {
    ...
    it("provides custom translations via provider", () => {
        ...
        render(<DeepCitationI18nProvider messages={messages}>
    ...
    it("falls back to defaults for non-overridden keys", () => {
        render(<DeepCitationI18nProvider messages={{ "status.verified": "Custom" }}>
    ...
    it("supports interpolation through the provider", () => {
        render(<DeepCitationI18nProvider messages={{}}>
