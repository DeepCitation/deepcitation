...
import { DISPLAY_CITATION_KEY, DISPLAY_NUMERIC_MARKERS, DISPLAY_POST_STREAM, DISPLAY_STREAMING, PROVIDER_ANTHROPIC, PROVIDER_GOOGLE, QUICKSTART_REACT_CLIENT, QUICKSTART_SERVER, RECIPE_KEEP_MARKERS, RECIPE_REACT_INLINE, RECIPE_STRIP, RECIPE_VERIFY_STATUS, SERVER_PERSIST, SERVER_VERIFY_EXPLICIT, SERVER_VERIFY_SIMPLE, SERVER_WRAP_PROMPTS, SETUP_IMPORT_TYPES, SETUP_INIT_CLIENT, SETUP_PREPARE_FILES, SETUP_PREPARE_URL, SETUP_PROOF_IMAGES, } from "../docs/integrationSnippets";
