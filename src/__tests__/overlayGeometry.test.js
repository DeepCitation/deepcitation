...
describe("computeAnnotationScrollTarget", () => {
    ...
    test("clamps to max scroll when annotation is near bottom-right", () => {
        ...
        const containerW = 800;
        const containerH = 600;
        const result = computeAnnotationScrollTarget(bottomRightItem, RENDER_SCALE, IMAGE_W, IMAGE_H, zoom, containerW, containerH);
        expect(result).not.toBeNull();
    ...
    test("start alignment positions left edge of annotation near viewport left", () => {
        ...
        const result = computeAnnotationScrollTarget(ITEM, RENDER_SCALE, IMAGE_W, IMAGE_H, zoom, containerW, containerH, "pdf", 0, "start");
        expect(result).not.toBeNull();
    ...
    test("start alignment clamps to 0 when annotation is near left edge", () => {
        ...
        const result = computeAnnotationScrollTarget(leftItem, RENDER_SCALE, IMAGE_W, IMAGE_H, 1, 400, 300, "pdf", 0, "start");
        expect(result).not.toBeNull();
        expect(result?.scrollLeft).toBe(0);
    });
    test("center alignment is default when alignX omitted", () => {
        ...
        const withCenter = computeAnnotationScrollTarget(ITEM, RENDER_SCALE, IMAGE_W, IMAGE_H, zoom, containerW, containerH, "pdf", 0, "center");
