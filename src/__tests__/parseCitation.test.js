...
import { getAllCitationsFromLlmOutput, groupCitationsByAttachmentId, normalizeCitationType, } from "../parsing/parseCitation.js";
...
<<<END_CITATION_DATA>>>`;
    ...
    describe("citation key generation", () => {
        ...
        it("generates 16-character citation keys", () => {
            const input = { sourceContext: "test", attachmentId: "f1" };
            const result = getAllCitationsFromLlmOutput(input);
...
describe("type guards", () => {
    it("isUrlCitation returns true for URL citations", () => {
        const citation = { type: "url", url: "https://example.com", sourceContext: "test" };
    ...
    it("isDocumentCitation returns true for document citations", () => {
        const citation = { type: "document", attachmentId: "abc", sourceContext: "test" };
