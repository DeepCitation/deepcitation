...
import { CITATION_X_PADDING, CITATION_Y_PADDING, classNames, generateCitationInstanceId, getCitationClaimText, getCitationNumber, getCitationSourceMatch, truncateMiddle, } from "../react/utils.js";
...
describe("react utils", () => {
    ...
    it("returns display text (sourceMatch with fallback to number)", () => {
        ...
        expect(getCitationClaimText({
            ...citation,
            sourceMatch: null,
            citationNumber: undefined,
        })).toBe("1");
        // Can use custom fallback
        expect(getCitationClaimText({ ...citation, sourceMatch: null, citationNumber: undefined }, { fallbackText: "N/A" })).toBe("N/A");
    });
    ...
    describe("isUrlCitation", () => {
        ...
        it("returns false when URL is undefined", () => {
            const citation = { sourceContext: "Test" };
            expect(isUrlCitation(citation)).toBe(false);
        });
    });
