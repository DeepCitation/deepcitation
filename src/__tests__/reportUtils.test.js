...
import { autoFixDisplayLabels, buildCitationMaps, injectCdnRuntime, reattachPageImages, replaceCitationMarkers, } from "../vanilla/reportUtils.js";
...
describe("reattachPageImages", () => {
    it("copies pageImages from attachments onto matching verifications", () => {
        ...
        const verifications = {
            ...
            k2: { status: "found", attachmentId: "att-2" },
        };
        reattachPageImages(verifications, { "att-1": { pageImages } });
        expect(verifications.k1.pageImages).toBe(pageImages);
        expect(verifications.k2.pageImages).toBeUndefined();
    });
    it("no-ops when attachments is undefined", () => {
        ...
        expect(verifications.k1.pageImages).toBeUndefined();
    });
});
