...
import { escapeForRegex, safeExec, safeMatch, safeReplace, safeReplaceAll, safeSearch, safeSplit, safeTest, validateRegexInput, } from "../utils/regexSafety";
    ...
    describe("Prototype Pollution Prevention (Object Safety)", () => {
        ...
        describe("createSafeObject", () => {
            ...
            it("should prevent prototype pollution", () => {
                ...
                expect(Object.create(null).polluted).toBeUndefined();
            });
        });
        describe("safeAssign", () => {
    ...
    describe("Proof Image Source Validation (isValidProofImageSrc)", () => {
        describe("trusted domains", () => {
            ...
            it("should accept Firebase Storage URLs", () => {
                expect(isValidProofImageSrc("https://firebasestorage.googleapis.com/v0/b/example.appspot.com/o/proof%2Fpage-1.avif?alt=media&token=abc123")).toBe(true);
            });
