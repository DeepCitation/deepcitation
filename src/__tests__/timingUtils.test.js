...
import { computeTimingMetrics, formatTtc, getTtcTier, TTC_INSTANT_THRESHOLD_MS, TTC_MAX_DISPLAY_MS, TTC_SLOW_THRESHOLD_MS, } from "../react/timingUtils.js";
describe("formatTtc", () => {
...
describe("computeTimingMetrics", () => {
    ...
    it("computes correct median for odd number of entries", () => {
        const verifications = {
            key1: { status: "found", timeToCertaintyMs: 1000 },
            key2: { status: "found", timeToCertaintyMs: 3000 },
            key3: { status: "found", timeToCertaintyMs: 2000 },
        };
        const result = computeTimingMetrics(verifications);
    ...
    it("computes correct median for even number of entries", () => {
        const verifications = {
            key1: { status: "found", timeToCertaintyMs: 1000 },
            key2: { status: "found", timeToCertaintyMs: 2000 },
            key3: { status: "found", timeToCertaintyMs: 3000 },
            key4: { status: "found", timeToCertaintyMs: 4000 },
        };
        const result = computeTimingMetrics(verifications);
    ...
    it("counts totalCount and resolvedCount correctly with mixed statuses", () => {
        const verifications = {
            key1: { status: "found", timeToCertaintyMs: 1000 },
            key2: { status: "pending", timeToCertaintyMs: undefined },
            key3: { status: "found", timeToCertaintyMs: 2000 },
            key4: { status: "loading", timeToCertaintyMs: undefined },
        };
        const result = computeTimingMetrics(verifications);
    ...
    it("computes correct min, max, and avg", () => {
        const verifications = {
            key1: { status: "found", timeToCertaintyMs: 1000 },
            key2: { status: "found", timeToCertaintyMs: 5000 },
            key3: { status: "found", timeToCertaintyMs: 3000 },
        };
        const result = computeTimingMetrics(verifications);
    ...
    it("handles zero TtC correctly", () => {
        const verifications = {
            key1: { status: "found", timeToCertaintyMs: 0 },
            key2: { status: "found", timeToCertaintyMs: 1000 },
        };
        const result = computeTimingMetrics(verifications);
