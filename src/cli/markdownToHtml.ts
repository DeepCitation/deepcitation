...
//
// Alternate LAYOUTS applied over the main report HTML as a post-processing
// step. Each variant fully replaces the author-controlled <style>…</style>
// block in the output HTML, preserving body markup and the CDN runtime
// injection so citation popovers still work for review.
//
// All variants use the --dc-* token system and system font stack per BRANDING.md.
...
const REVIEW_VARIANTS: ReviewVariant[] = [
  // Future layout variants will be added here
];
