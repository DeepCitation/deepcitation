...
function getChipVisualClasses(status: CitationStatus): ChipVisualClasses {
  if (status.isPartialMatch) {
    return {
      ...
      hover: "hover:bg-dc-partial-hover hover:text-dc-partial-hover-foreground",
  ...
  if (status.isMiss) {
    return {
      ...
      hover: "hover:bg-dc-destructive-hover hover:text-dc-destructive-hover-foreground",
  ...
  if (status.isVerified) {
    return {
      ...
      hover: "hover:bg-dc-verified-hover hover:text-dc-verified-hover-foreground",
  ...
  if (status.isPending) {
    return {
      ...
      hover: "hover:bg-dc-pending-hover hover:text-dc-pending-hover-foreground",
