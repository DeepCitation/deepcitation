...
export const defaultMessages = {
  ...
  "aria.keyhole.expandImage": "Click to view full size",
  "aria.keyhole.expandPage": "Click to view full page",
  "aria.viewPage": "View page",
  "aria.viewPageNum": "View page {pageNumber}",
  "aria.expandedImageViewer": "Expanded verification image. Press Escape or Enter to collapse. Use arrow keys to pan.",
  "aria.tapToViewFullSize": "Tap to view full size",
  "aria.clickToViewFullSize": "Click to view full size",
  ...
  "search.method.sourceMatchFallback": "Anchor text",
  ...
  "searchPhrase.sourceMatch": "Anchor text",
  "searchPhrase.sourceContext": "Full phrase",
  ...
  // ── URL status labels ──────────────────────────────────────────
  "urlStatus.verified": "Verified",
  "urlStatus.partial": "Partial match",
  "urlStatus.pending": "Verifying",
  "urlStatus.accessible": "Accessible",
  "urlStatus.redirected": "Redirected",
  "urlStatus.redirectedValid": "Redirected (valid)",
  "urlStatus.blockedAntibot": "Blocked by anti-bot",
  "urlStatus.blockedLogin": "Login required",
  "urlStatus.blockedPaywall": "Paywall",
  "urlStatus.blockedGeo": "Geo-restricted",
  "urlStatus.blockedRateLimit": "Rate limited",
  "urlStatus.errorTimeout": "Timed out",
  "urlStatus.errorNotFound": "Not found",
  "urlStatus.errorServer": "Server error",
  "urlStatus.errorNetwork": "Network error",
  "urlStatus.unknown": "Unknown status",
