...
export const DeepCitationIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M4 1 L1 1 L1 23 L4 23" className="text-dc-muted-foreground" strokeWidth="1" />
    <path d="M20 1 L23 1 L23 23 L20 23" className="text-dc-muted-foreground" strokeWidth="1" />
