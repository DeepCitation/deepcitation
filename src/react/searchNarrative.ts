...
import { defaultTranslator, type MessageKey, type TranslateFunction, tPlural } from "./i18n.js";
...
function deriveOutcome(status: SearchStatus | null | undefined): NarrativeOutcome {
