...
export function AnimationDebugHarness() {
    ...
    return (<div data-dc-debug-harness="" style={{ font: "14px/1.4 system-ui, sans-serif" }}>
      <ControlBar />
      <GhostRectsOverlay />
        ...
        <section data-dc-debug-panel="live">
          ...
          <div style={livePanelFrame}>
            <p style={{ margin: 0 }}>
              ...
              {verification && pageImages ? (<CitationComponent citation={citation} verification={verification} pageImagesByAttachmentId={pageImages}/>) : (<span>(loading fixture…)</span>)}{" "}
...
function AimAlignmentPanel({ citation, verification, pageImages, }) {
    ...
    if (!verification || !pageImages) {
        return (<section data-dc-debug-panel="aim-alignment">
