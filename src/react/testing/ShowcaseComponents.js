...
function ShowcaseLabel({ component, variant, state, uxIntent }) {
    return (<div className="mb-2 pb-2 border-b border-gray-200 dark:border-gray-700">
      <div className="flex flex-wrap gap-2 items-center text-xs">
        <span className="font-semibold text-blue-600 dark:text-blue-400">{component}</span>
        {variant && (<span className="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded font-mono">
            {variant}
          </span>)}
        {state && (<span className="px-1.5 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded font-mono">
            {state}
          </span>)}
      </div>
...
function InteractionLabel({ hover, click, secondClick, escapeKey, children }) {
    return (<div className="mt-2 pt-2 border-t border-dashed border-gray-200 dark:border-gray-700">
...
function ShowcaseSection({ title, description, children, "data-testid": testId }) {
    return (<section className="mb-10" data-testid={testId}>
...
function ShowcaseCard({ children, className = "", "data-testid": testId, ...dataProps }) {
    return (<div className={`p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 ${className}`} data-testid={testId} {...dataProps}>
      {children}
    </div>);
}
// =============================================================================
...
const CITATION_VARIANTS = ["brackets", "chip", "text", "superscript", "footnote", "linter", "badge"];
/** Mobile-friendly citation variants */
const MOBILE_CITATION_VARIANTS = ["brackets", "chip", "text", "superscript", "footnote", "linter"];
/** Content type options */
const CONTENT_TYPES = ["number", "sourceMatch", "indicator"];
/** URL citation variant types */
const URL_VARIANTS = ["badge", "chip", "inline", "bracket"];
/** Mobile URL status examples */
const MOBILE_URL_STATUSES = ["verified", "blocked_login", "error_not_found"];
...
const longCitation = {
    ...baseCitation,
    sourceContext: "The quarterly financial report indicates that revenue increased by 15% compared to the same period last year, driven primarily by strong performance in the enterprise segment.",
...
const partialMatchSearchAttempts = [
    {
        method: "exact_line_match",
        success: false,
        searchPhrase: "Revenue increased by 15% in Q4 2024.",
...
export function VisualShowcase() {
    return (<div className="p-6 bg-white dark:bg-gray-900 min-h-screen" data-testid="visual-showcase">
      ...
      <ShowcaseSection title="All Variants × All States" description="Matrix showing every visual variant combined with every verification state" data-testid="variants-section">
        <ShowcaseCard data-testid="variants-matrix">
          <ShowcaseLabel component="CitationComponent" uxIntent="Display inline citations with verification status - visual variants for different contexts"/>
          <div className="overflow-x-auto">
            <table className="w-full min-w-[600px] border-collapse text-sm">
              ...
              <tbody>
                {CITATION_VARIANTS.map(variant => (<tr key={variant} className="border-b border-gray-100 dark:border-gray-800" data-variant-row={variant}>
          ...
          <InteractionLabel hover="Highlight effect on component" click="Opens popover with verification details" secondClick="Toggles search details expansion in popover" escapeKey="Closes popover"/>
        </ShowcaseCard>
      </ShowcaseSection>

      {/* Section: Content Types */}
      <ShowcaseSection title="Content Types" description="What text/content is displayed inside the citation component" data-testid="content-section">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {CONTENT_TYPES.map(content => (<ShowcaseCard key={content} data-content-type={content}>
              <ShowcaseLabel component="CitationComponent" variant="brackets" state={content} uxIntent={content === "number"
              ...
              <div className="py-2">
                <CitationComponent citation={baseCitation} verification={verifiedVerification} variant="brackets" content={content}/>
              </div>
            </ShowcaseCard>))}
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title='Indicator Variant "none"' description='Use indicatorVariant="none" to hide the status indicator (checkmark, warning, spinner)' data-testid="indicator-none-section">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <ShowcaseCard data-indicator-none="default">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state='indicatorVariant="icon"' uxIntent="Default - shows verification status icon"/>
            <div className="py-2">
          ...
          <ShowcaseCard data-indicator-none="none">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state='indicatorVariant="none"' uxIntent="No indicator - cleaner look, status via popover only"/>
            <div className="py-2">
              <CitationComponent citation={baseCitation} verification={verifiedVerification} variant="brackets" indicatorVariant="none"/>
            </div>
          </ShowcaseCard>
          <ShowcaseCard data-indicator-none="chip-icon">
            <ShowcaseLabel component="CitationComponent" variant="chip" state='indicatorVariant="icon"' uxIntent="Chip with indicator - prominent status display"/>
            <div className="py-2">
          ...
          <ShowcaseCard data-indicator-none="chip-none">
            <ShowcaseLabel component="CitationComponent" variant="chip" state='indicatorVariant="none"' uxIntent="Chip without indicator - badge-only appearance"/>
            <div className="py-2">
              <CitationComponent citation={baseCitation} verification={verifiedVerification} variant="chip" indicatorVariant="none"/>
            </div>
          </ShowcaseCard>
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="Indicator Variants" description="Different indicator styles: icon (default), dot, caret, none" data-testid="indicator-variants-section">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {["icon", "dot", "caret", "none"].map(iv => (<ShowcaseCard key={iv} data-indicator-variant={iv}>
              <ShowcaseLabel component="CitationComponent" variant="text" state={`indicatorVariant="${iv}"`} uxIntent={iv === "icon"
              ...
              <div className="py-2">
                <CitationComponent citation={baseCitation} verification={verifiedVerification} variant="text" indicatorVariant={iv}/>
              </div>
            </ShowcaseCard>))}
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="Long Text Handling" description="How components handle long anchor text content" data-testid="long-text-section">
        <div className="space-y-4">
          <ShowcaseCard>
            <ShowcaseLabel component="CitationComponent" variant="chip" state="long sourceMatch" uxIntent="Chip truncates long text to prevent layout breaking"/>
            <div className="py-2">
              <CitationComponent citation={longCitation} verification={verifiedVerification} variant="chip" content="sourceMatch"/>
            </div>
          </ShowcaseCard>
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="Verification Audit Log States" description="Citations with different search attempt histories - helps auditors understand why verification failed" data-testid="audit-log-section">
        <div className="grid grid-cols-2 gap-3">
          <ShowcaseCard className="border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10" data-audit="not-found">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="not_found" uxIntent="Not Found - shows 6 failed search attempts in popover audit log"/>
            <div className="py-2">
              <CitationComponent citation={baseCitation} verification={notFoundWithAudit} variant="brackets"/>
            </div>
            <InteractionLabel click="Opens popover showing 'couldn't find' status" secondClick="Expands search timeline showing all 6 failed attempts"/>
          </ShowcaseCard>

          <ShowcaseCard className="border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-900/10" data-audit="partial">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="found_on_other_page" uxIntent="Partial Match - found on page 7 instead of expected page 5"/>
            <div className="py-2">
              <CitationComponent citation={baseCitation} verification={partialWithAudit} variant="brackets"/>
            </div>
            <InteractionLabel click="Opens popover showing page mismatch" secondClick="Expands search timeline showing where text was found"/>
          </ShowcaseCard>

          <ShowcaseCard className="border-amber-200 dark:border-amber-800 bg-amber-50/50 dark:bg-amber-900/10" data-audit="low-trust">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="first_word_found" uxIntent="Low Trust - only first word matched, requires manual review"/>
            <div className="py-2">
              <CitationComponent citation={baseCitation} verification={lowTrustWithAudit} variant="brackets"/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10" data-audit="with-variations">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="not_found + variations" uxIntent="Spelling variations shown - helps auditor spot Penicillin/penicillin differences"/>
            <div className="py-2">
              <CitationComponent citation={{
            ...baseCitation,
            sourceContext: "Patient is allergic to penicillin",
            sourceMatch: "allergic to penicillin",
        }} verification={notFoundWithVariations} variant="brackets"/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10" data-audit="rejected-matches">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="not_found + rejected" uxIntent="Shows why matches were rejected - $0.00 found but wrong context"/>
            <div className="py-2">
              <CitationComponent citation={{
            ...baseCitation,
            sourceContext: "Total cost is $0.00",
            sourceMatch: "$0.00",
        }} verification={notFoundWithRejectedMatches} variant="brackets"/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10" data-audit="many-pages">
            <ShowcaseLabel component="CitationComponent" variant="brackets" state="not_found + many pages" uxIntent="Many pages searched - tests UI collapsing of page numbers"/>
            <div className="py-2">
              <CitationComponent citation={{
            ...baseCitation,
            sourceContext: "Quarterly earnings report",
            sourceMatch: "earnings report",
        }} verification={notFoundManyPages} variant="brackets"/>
            </div>
          </ShowcaseCard>
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="URL Citations - All Fetch Statuses" description="URL citation component showing all possible fetch/verification states" data-testid="url-section">
        <ShowcaseCard>
          <ShowcaseLabel component="UrlCitationComponent" uxIntent="Display URL source references with fetch status indicators"/>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            ...
            return (<div key={status} className="p-2 bg-gray-50 dark:bg-gray-800 rounded" data-url-status={status}>
      ...
      <ShowcaseSection title="URL Citation Variants" description="Different visual styles for URL citations" data-testid="url-variants-section">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {URL_VARIANTS.map(variant => {
            ...
            return (<ShowcaseCard key={variant} data-url-variant={variant}>
                <ShowcaseLabel component="UrlCitationComponent" variant={variant} uxIntent={variant === "badge"
      ...
      <ShowcaseSection title="Inline Usage Context" description="How citations appear in flowing paragraph text" data-testid="inline-context-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="superscript" uxIntent="Superscript citations for academic/footnote style inline references"/>
          <div className="py-4 text-gray-700 dark:text-gray-300">
            <p className="leading-relaxed">
              ...
              <CitationComponent citation={{ ...baseCitation, citationNumber: 2 }} verification={partialVerification} variant="superscript"/>
              compared to the previous quarter. However, some claims could not be verified
              <CitationComponent citation={{ ...baseCitation, citationNumber: 3 }} verification={notFoundVerification} variant="superscript"/>
              and require further review.
            </p>
          </div>
          <InteractionLabel hover="Subtle highlight on superscript" click="Opens popover positioned near the superscript"/>
        </ShowcaseCard>

        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="footnote" uxIntent="Footnote citations for clean, neutral inline references"/>
          <div className="py-4 text-gray-700 dark:text-gray-300">
            <p className="leading-relaxed">
              According to the Q4 financial report, the company saw significant growth
              <CitationComponent citation={baseCitation} verification={verifiedVerification} variant="footnote"/>
              with revenue increasing by 15%
              <CitationComponent citation={{ ...baseCitation, citationNumber: 2 }} verification={partialVerification} variant="footnote"/>
              compared to the previous quarter. However, some claims could not be verified
              <CitationComponent citation={{ ...baseCitation, citationNumber: 3 }} verification={notFoundVerification} variant="footnote"/>
              and require further review.
            </p>
          </div>
          <InteractionLabel hover="Subtle highlight on footnote marker" click="Opens popover positioned near the footnote"/>
        </ShowcaseCard>
      </ShowcaseSection>
    </div>);
}
...
export function MobileShowcase() {
    return (<div className="p-4 bg-white dark:bg-gray-900 min-h-screen" data-testid="mobile-showcase">
      ...
      <section className="mb-6" data-testid="mobile-variants">
        ...
        <div className="space-y-2">
          {MOBILE_CITATION_VARIANTS.map(variant => (<div key={variant} className="flex items-center gap-2 p-2 bg-gray-50 dark:bg-gray-800 rounded" data-mobile-variant={variant}>
      ...
      <section className="mb-6" data-testid="mobile-urls">
        ...
        <div className="space-y-2">
          {MOBILE_URL_STATUSES.map(status => {
            ...
            return (<div key={status} className="p-2 bg-gray-50 dark:bg-gray-800 rounded" data-mobile-url={status}>
...
export function PopoverShowcase() {
    return (<div className="p-6 bg-white dark:bg-gray-900 min-h-screen" data-testid="popover-showcase">
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="1. Loading/Pending States" description="Popover content shown while verification is in progress" data-testid="popover-pending-section">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ShowcaseCard data-popover-state="pending">
            <ShowcaseLabel component="PopoverContent" state="pending" uxIntent="Show search progress - phrase being searched and target page"/>
          ...
          <ShowcaseCard data-popover-state="loading-long">
            <ShowcaseLabel component="PopoverContent" state="pending + long phrase" uxIntent="Long phrases are truncated with ellipsis to fit popover width"/>
            <div className="p-3 flex flex-col gap-2 min-w-[200px] max-w-[400px] bg-gray-50 dark:bg-gray-800 rounded">
              <span className="text-xs font-medium text-gray-500 dark:text-gray-400">
                <span className="inline-block relative top-[0.1em] mr-1.5 size-3 animate-spin">
                  <SpinnerIcon />
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="2. StatusHeader Sub-Component" description="Header row showing verification status with icon and page information" data-testid="popover-status-headers-section">
        <ShowcaseCard className="mb-4">
          <ShowcaseLabel component="StatusHeader" uxIntent="Communicate verification result at a glance - color-coded status with page context"/>
          <InteractionLabel>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {allVerificationStatuses.map(({ status, description, color }) => {
            ...
            return (<ShowcaseCard key={status} className={borderColor} data-status-header={status}>
                ...
                <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
                  <StatusHeader status={status} foundPage={foundPage} expectedPage={expectedPage} sourceMatch="revenue increased by 15%"/>
                </div>
              </ShowcaseCard>);
        })}
        </div>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="3. QuoteBox Sub-Component" description="Displays the cited phrase in a styled quote box" data-testid="popover-quotebox-section">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <ShowcaseCard data-quotebox="short">
            <ShowcaseLabel component="QuoteBox" state="short" uxIntent="Brief citation - displays fully without truncation"/>
            <div className="mt-2">
          ...
          <ShowcaseCard data-quotebox="medium">
            <ShowcaseLabel component="QuoteBox" state="medium" uxIntent="Medium-length citation - may wrap to multiple lines"/>
            <div className="mt-2">
          ...
          <ShowcaseCard data-quotebox="long">
            <ShowcaseLabel component="QuoteBox" state="long (truncated)" uxIntent="Long citation - truncated at ~150 chars with ellipsis"/>
            <div className="mt-2">
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="4. VerificationLog (Search Timeline) Sub-Component" description="Collapsible timeline showing all search attempts - helps auditors understand verification process" data-testid="popover-verification-log-section">
        <ShowcaseCard className="mb-4">
          <ShowcaseLabel component="VerificationLog" uxIntent="Audit trail of search attempts - shows methods tried, pages searched, and why matches were accepted/rejected"/>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ShowcaseCard className="border-red-200 dark:border-red-800" data-verification-log="not-found">
            <ShowcaseLabel component="VerificationLog" state="not_found" uxIntent="All 6 search attempts failed - collapsed view shows summary"/>
            <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
              <VerificationLog searchAttempts={failedSearchAttempts} status="not_found" expectedPage={5} expectedLine={12}/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-amber-200 dark:border-amber-800" data-verification-log="partial-page">
            <ShowcaseLabel component="VerificationLog" state="found_on_other_page" uxIntent="Found on page 7 instead of expected page 5"/>
            <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
              <VerificationLog searchAttempts={partialMatchSearchAttempts} status="found_on_other_page" expectedPage={5} foundPage={7}/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-amber-200 dark:border-amber-800" data-verification-log="partial-line">
            <ShowcaseLabel component="VerificationLog" state="found_on_other_line" uxIntent="Found on line 45 instead of expected line 12"/>
            <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
              <VerificationLog searchAttempts={[
            {
                method: "exact_line_match",
                success: false,
        ...
        ]} status="found_on_other_line" expectedPage={5} expectedLine={12} foundPage={5} foundLine={45}/>
            </div>
          </ShowcaseCard>

          <ShowcaseCard className="border-amber-200 dark:border-amber-800" data-verification-log="low-trust">
            <ShowcaseLabel component="VerificationLog" state="first_word_found" uxIntent="Low confidence - only 'Revenue' matched, full phrase not found"/>
            <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
              <VerificationLog searchAttempts={lowTrustSearchAttempts} status="first_word_found" expectedPage={5} foundPage={3}/>
            </div>
          </ShowcaseCard>
        </div>
      </ShowcaseSection>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="5. VerificationLog (Expanded Timeline)" description="Full search timeline visible - shows each search method and result" data-testid="popover-verification-log-expanded-section">
        <ShowcaseCard className="max-w-lg" data-verification-log="expanded">
          <ShowcaseLabel component="VerificationLog" state="expanded" uxIntent="Expanded view shows complete audit trail - each search method, phrase variation, and page checked"/>
          <div className="mt-2 rounded overflow-hidden border border-gray-200 dark:border-gray-700">
            <VerificationLog searchAttempts={failedSearchAttempts} status="not_found" expectedPage={5} expectedLine={12} isExpanded={true}/>
          </div>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="6. Complete Popover Layouts" description="Full popover compositions showing all sub-components together" data-testid="popover-complete-layouts-section">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Verified with image */}
          <ShowcaseCard data-complete-popover="verified-with-image">
            <ShowcaseLabel component="Popover" variant="verified" state="with image" uxIntent="Success state - shows verification image with 'click to expand' overlay"/>
            <div className="mt-2 overflow-hidden rounded-lg border border-green-200 dark:border-green-800 bg-white dark:bg-gray-900" style={{ width: "380px", maxWidth: "100%" }}>
              ...
              <div className="p-2">
                <div className="group block relative overflow-hidden rounded-md bg-gray-50 dark:bg-gray-800 w-full">
                  <img src={sampleImage} alt="Citation verification" className="block rounded-md w-full" style={{
        ...
        ]} status="found" expectedPage={5} expectedLine={12} foundPage={5} foundLine={12}/>
            </div>
          ...
          <ShowcaseCard data-complete-popover="partial-with-image">
            <ShowcaseLabel component="Popover" variant="partial" state="with image" uxIntent="Partial match - amber status indicates location mismatch"/>
            <div className="mt-2 overflow-hidden rounded-lg border border-amber-200 dark:border-amber-800 bg-white dark:bg-gray-900" style={{ width: "380px", maxWidth: "100%" }}>
          ...
          <ShowcaseCard data-complete-popover="not-found-no-image">
            <ShowcaseLabel component="Popover" variant="not_found" state="no image" uxIntent="Failed verification - no image available, shows search log for debugging"/>
            <div className="mt-2 overflow-hidden rounded-lg border border-red-200 dark:border-red-800 bg-white dark:bg-gray-900" style={{ width: "380px", maxWidth: "100%" }}>
              <StatusHeader status="not_found" expectedPage={5} sourceMatch="increased by 15%" sourceContext="Revenue increased by 15% in Q4 2024."/>
              <VerificationLog searchAttempts={failedSearchAttempts} status="not_found" expectedPage={5} expectedLine={12}/>
            </div>
          </ShowcaseCard>
          ...
          <ShowcaseCard data-complete-popover="text-only">
            <ShowcaseLabel component="Popover" variant="text-only" state="fallback" uxIntent="Minimal fallback when no image - just status, quote, and page"/>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="7. Image Overlay (Page Viewer)" description="Full-screen overlay for viewing verification images at full size" data-testid="popover-image-overlay-section">
        <ShowcaseCard data-image-overlay="static">
          <ShowcaseLabel component="ImageOverlay" uxIntent="Full-screen image viewer - allows zooming into verification evidence"/>
          <div className="mt-4">
            ...
            <div className="relative rounded-lg overflow-hidden bg-black/80 p-8" style={{ minHeight: "200px" }}>
              <div className="flex items-center justify-center">
                <img src={sampleLargeImage} alt="Sample verification - full size" className="max-w-full max-h-[300px] object-contain rounded shadow-2xl" style={{ backgroundColor: "#22c55e" }}/>
              </div>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="8. Interactive Popover Examples" description="Live interactive citations - click to see actual popover behavior" data-testid="popover-interactive-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" uxIntent="Test actual click/popover behavior - popovers open on click (lazy mode)"/>
          ...
          <InteractionLabel hover="Highlight effect only (no popover)" click="Opens popover with verification details" secondClick="Toggles search details expansion" escapeKey="Closes popover"/>
        </ShowcaseCard>
      </ShowcaseSection>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="9. URL Citation Popover Examples" description="URL citations with popover showing source URL header" data-testid="popover-url-citation-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="url" uxIntent="URL citations show source URL in header instead of page number"/>
          <div className="flex flex-wrap gap-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mt-4">
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="9b. URL Access Failure Popovers" description="Click each citation to see detailed explanations of why the URL couldn't be accessed, with actionable suggestions" data-testid="popover-url-access-failure-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="url" state="blocked" uxIntent="Blocked URLs show amber explanation with actionable suggestion to resolve"/>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            {urlAccessFailureFixtures
            .filter(f => f.category === "blocked")
            .map(fixture => (<div key={fixture.label} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg" data-interactive-popover={`url-${fixture.label.toLowerCase().replace(/\s+/g, "-")}`}>
        ...
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="url" state="error" uxIntent="Error URLs show red explanation with guidance on what went wrong"/>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            {urlAccessFailureFixtures
        ...
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" variant="url / chip" state="all failures" uxIntent="Chip variant shows same explanations with chip styling"/>
          <div className="flex flex-wrap gap-3 mt-4">
            {urlAccessFailureFixtures.map(fixture => (<div key={fixture.label} data-interactive-popover={`url-chip-${fixture.label.toLowerCase().replace(/\s+/g, "-")}`}>
      ...
      {/* ========================================================================
            ...
            ======================================================================== */}
      <ShowcaseSection title="10. Accessibility & Contrast Testing" description="Test visibility on various backgrounds - especially important for not-found states" data-testid="gray-background-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationComponent" uxIntent="Ensure citations remain visible and readable on gray/colored backgrounds"/>
...
export function CitationDrawerShowcase() {
    ...
    const [interactiveItems] = useState(drawerMixed);
    ...
    return (<div className="p-6 bg-white dark:bg-gray-900 min-h-screen overflow-hidden" data-testid="drawer-showcase">
      ...
      {/* ========
            ...
            ======== */}
      <ShowcaseSection title="1. Trigger States" description="The trigger bar in its collapsed state across different verification scenarios" data-testid="drawer-trigger-states-section">
        <div className="grid grid-cols-1 gap-4">
          <ShowcaseCard data-drawer-trigger-state="all-verified">
            <ShowcaseLabel component="CitationDrawerTrigger" state="all-verified" uxIntent="All citations verified — green checkmark icons signal confidence"/>
            <div className="mt-3">
          ...
          <ShowcaseCard data-drawer-trigger-state="mixed">
            <ShowcaseLabel component="CitationDrawerTrigger" state="mixed" uxIntent="Mixed statuses — stacked icons show at-a-glance verification breakdown"/>
            <div className="mt-3">
          ...
          <ShowcaseCard data-drawer-trigger-state="all-pending">
            <ShowcaseLabel component="CitationDrawerTrigger" state="all-pending" uxIntent="All citations pending — gray spinner icons indicate in-progress verification"/>
            <div className="mt-3">
          ...
          <ShowcaseCard data-drawer-trigger-state="single-source">
            <ShowcaseLabel component="CitationDrawerTrigger" state="single-source" uxIntent="Single source — minimal trigger for simple citations"/>
            <div className="mt-3">
          ...
          <ShowcaseCard data-drawer-trigger-state="many-sources">
            <ShowcaseLabel component="CitationDrawerTrigger" state="many-sources" uxIntent="Many sources — overflow favicons with +N badge"/>
            <div className="mt-3">
      ...
      {/* ========
            ...
            ======== */}
      <ShowcaseSection title="2. Hover Progressive Disclosure" description="On hover, stacked verification icons spread horizontally. Hovering individual icons shows source tooltips with proof thumbnails." data-testid="drawer-trigger-hover-section">
        <div className="grid gap-4 md:grid-cols-2">
          <ShowcaseCard data-drawer-hover-state="collapsed">
            <ShowcaseLabel component="CitationDrawerTrigger" state="collapsed" uxIntent="Default collapsed state — stacked verification icons in single line"/>
            <div className="mt-3">
              <CitationDrawerTrigger citationGroups={mixedGroups}/>
            </div>
            <InteractionLabel hover="Icons spread horizontally, hover individual icon for source tooltip" click="Opens full citation drawer" escapeKey="N/A (not a modal)"/>
          </ShowcaseCard>

          <ShowcaseCard data-drawer-hover-state="expanded-preview">
            <ShowcaseLabel component="CitationDrawerTrigger" state="hover behavior" uxIntent="Hover spreads icons horizontally — each icon shows source tooltip with filename and proof"/>
      ...
      {/* ========
            ...
            ======== */}
      <ShowcaseSection title="3. Full Drawer Content (Static Preview)" description="The citation drawer content rendered inline — shows grouped citations by source" data-testid="drawer-trigger-full-drawer-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationDrawer" uxIntent="Grouped drawer content — citations organized by source with collapsible headers, page numbers, and proof images"/>
          <div className="mt-3 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900">
            ...
            {mixedGroups.map((group, groupIndex) => (<div key={`${group.sourceDomain ?? group.sourceName}-${groupIndex}`}>
                {/* Source group header */}
                <div className="w-full px-4 py-2.5 flex items-center gap-2.5 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                  {group.sourceFavicon ? (<img src={group.sourceFavicon} alt="" className="w-4 h-4 rounded-sm object-contain" loading="lazy"/>) : (<div className="w-4 h-4 rounded-sm bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                ...
                {group.citations.map((item, index) => (<CitationDrawerItemComponent key={item.citationKey} item={item} isLast={groupIndex === mixedGroups.length - 1 && index === group.citations.length - 1}/>))}
              </div>))}
          </div>
        </ShowcaseCard>
      </ShowcaseSection>
      ...
      {/* ========
            ...
            ======== */}
      <ShowcaseSection title="4. Interactive Example" description="Click the trigger bar below to open the full citation drawer" data-testid="drawer-trigger-interactive-section">
        <ShowcaseCard>
          <ShowcaseLabel component="CitationDrawerTrigger + CitationDrawer" uxIntent="Complete integration — trigger bar opens drawer on click"/>
          <div className="mt-3" data-interactive-drawer="trigger">
            <CitationDrawerTrigger citationGroups={interactiveGroups} onClick={() => setDrawerOpen(true)} isOpen={drawerOpen}/>
          </div>
          <InteractionLabel hover="Spreads verification icons, hover individual icon for source tooltip" click="Opens full citation drawer" escapeKey="Closes drawer"/>
        </ShowcaseCard>
      </ShowcaseSection>
      ...
      {/* ========
            ...
            ======== */}
      <ShowcaseSection title="5. Overflow Cap — Large Citation Sets" description="When citations exceed maxIcons=5, the trigger collapses remaining icons into a +N chip. The drawer header shows the same StackedStatusIcons component with the same cap." data-testid="drawer-trigger-overflow-section">
        <div className="grid gap-4 md:grid-cols-2">
          <ShowcaseCard data-drawer-trigger-state="overflow-trigger">
            <ShowcaseLabel component="CitationDrawerTrigger" state="8 citations / maxIcons=5" uxIntent="Icons cap at 5 — worst-status-first order ensures failures are always visible; remainder collapses into +N chip"/>
            <div className="mt-3">
              <CitationDrawerTrigger citationGroups={overflowGroups}/>
            </div>
            <InteractionLabel hover="Spreads the 5 visible icons, hover individual for source tooltip" click="Opens drawer — header shows same icons with overflow cap"/>
          </ShowcaseCard>

          <ShowcaseCard data-drawer-trigger-state="overflow-interactive">
            <ShowcaseLabel component="CitationDrawerTrigger + CitationDrawer" state="overflow + drawer header icons" uxIntent="Opening the drawer reveals the same StackedStatusIcons in the header — trigger and drawer header use identical component and cap"/>
            <div className="mt-3" data-interactive-drawer="overflow-trigger">
              <CitationDrawerTrigger citationGroups={overflowGroups} onClick={() => setOverflowDrawerOpen(true)} isOpen={overflowDrawerOpen}/>
            </div>
            <InteractionLabel click="Opens drawer — compare header icons to the trigger icons above" escapeKey="Closes drawer"/>
          </ShowcaseCard>
        </div>
      </ShowcaseSection>
      ...
      <CitationDrawer isOpen={overflowDrawerOpen} onClose={() => setOverflowDrawerOpen(false)} citationGroups={overflowGroups}/>
    </div>);
}
