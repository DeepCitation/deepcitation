        ...
        <div className="space-y-4">
          ...
          <ShowcaseCard>
            <ShowcaseLabel
              ...
              variant="minimal"
              state="long anchorText"
              uxIntent="Minimal variant with long text - inline flow"
            />
            <div className="py-2">
              <CitationComponent
                citation={longCitation}
...
const allVerificationStatuses: Array<{ status: SearchStatus; label: string; description: string; color: string }> = [
  // Green statuses
  { status: "found", label: "Found", description: "Exact match verified", color: "green" },
  { status: "found_anchor_text_only", label: "Anchor Text Only", description: "Anchor text matched", color: "green" },
  {
  ...
  // Amber statuses
  { status: "found_on_other_page", label: "Other Page", description: "Found on different page", color: "amber" },
  { status: "found_on_other_line", label: "Other Line", description: "Found on different line", color: "amber" },
  { status: "partial_text_found", label: "Partial Text", description: "Partial text matched", color: "amber" },
  { status: "first_word_found", label: "First Word", description: "Only first word matched", color: "amber" },
  // Red statuses
  { status: "not_found", label: "Not Found", description: "Citation could not be verified", color: "red" },
  // Gray statuses
  { status: "pending", label: "Pending", description: "Verification in progress", color: "gray" },
  { status: "loading", label: "Loading", description: "Loading verification", color: "gray" },
];
    ...
    <div className="p-6 bg-white dark:bg-gray-900 min-h-screen" data-testid="popover-showcase">
      ...
      >
        <ShowcaseCard className="mb-4">
          ...
          />
          <InteractionLabel
            click="Toggle expansion to show/hide full search timeline"
          >
            <li className="text-[10px]">
        ...
        <ShowcaseCard data-image-overlay="static">
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              The image overlay appears when clicking on a verification image in the popover.
              It displays the image at full size with a dark backdrop.
            </p>
          ...
          >
            <li className="text-[10px]">
              <span className="font-medium text-gray-600 dark:text-gray-300">Opens via:</span>{" "}
              Clicking image in popover or via behaviorConfig.onClick returning setImageExpanded
            </li>
          </InteractionLabel>
        </ShowcaseCard>
      </ShowcaseSection>
      ...
      >
        <ShowcaseCard>
          ...
          <div className="mt-4 p-6 bg-gray-200 dark:bg-gray-700 rounded-lg space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <span className="text-sm text-gray-700 dark:text-gray-200 font-medium">Minimal:</span>
