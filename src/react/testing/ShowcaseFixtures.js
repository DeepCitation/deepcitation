...
export const allVerificationStatuses = [
    // Green statuses
    {
        status: "found",
        label: "Found",
...
function makeUrlCitation(url, domain, title) {
    return {
        type: "url",
        url,
        domain,
...
export const urlAccessFailureFixtures = [
    // Blocked scenarios (amber — potentially resolvable by the user)
    {
        label: "Paywall",
        description: "Site requires paid subscription",
        category: "blocked",
        citation: makeUrlCitation("https://www.nytimes.com/2024/03/15/business/economy/gdp-growth.html", "nytimes.com", "GDP Growth Exceeds Expectations in Q1"),
    ...
    },
    {
        ...
        category: "blocked",
        citation: makeUrlCitation("https://members.example.com/research/annual-report", "members.example.com", "Annual Research Report 2024"),
    ...
    },
    {
        ...
        category: "blocked",
        citation: makeUrlCitation("https://www.bbc.co.uk/iplayer/episode/b09xyz123", "bbc.co.uk", "BBC Documentary: Climate Change"),
    ...
    },
    {
        ...
        category: "blocked",
        citation: makeUrlCitation("https://protected-site.com/data/quarterly-results", "protected-site.com", "Quarterly Financial Results"),
    ...
    },
    {
        ...
        category: "blocked",
        citation: makeUrlCitation("https://api.example.com/v2/articles/12345", "api.example.com", "API Documentation Article"),
    ...
    // Error scenarios (red — likely can't be resolved without fixing the URL)
    {
        ...
        category: "error",
        citation: makeUrlCitation("https://example.com/blog/deleted-post-2023", "example.com", "Understanding Market Trends"),
    ...
    },
    {
        ...
        category: "error",
        citation: makeUrlCitation("https://unstable-service.com/api/reports", "unstable-service.com", "Service Status Report"),
    ...
    },
    {
        ...
        category: "error",
        citation: makeUrlCitation("https://slow-cdn.example.com/resources/whitepaper.html", "slow-cdn.example.com", "Industry Whitepaper 2024"),
    ...
    },
    {
        ...
        category: "error",
        citation: makeUrlCitation("https://nonexistent-domain.test/article/research", "nonexistent-domain.test", "Research Findings Summary"),
