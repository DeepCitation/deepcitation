/**
 * URL access explanation — mapping and rendering for URL access failures.
 *
 * Self-contained module handling the conversion from API access statuses
 * to user-facing explanations, plus the banner component.
 *
 ...
 */
export function UrlAccessExplanationSection({ explanation }: { explanation: UrlAccessExplanation }) {
