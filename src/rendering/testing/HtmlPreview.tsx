...
function getPreviewCss(): string {
  return [
    ...
    ".dc-preview-scope .dc-pending { color: #a1a1aa; }",
    ...
    ".dc-preview-scope span.dc-citation.dc-pending { text-decoration: underline dotted #a1a1aa; text-underline-offset: 3px; }",
    ...
    ".dc-preview-scope .dc-chip.dc-pending { background: #fafafa; border-color: #e4e4e7; }",
