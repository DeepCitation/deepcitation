...
export function WideEvidenceCitation() {
    const pageSrc = useMemo(() => drawCanvas(800, 1600, "Wide evidence technique page", { x: 500, y: 600, w: 170, h: 34 }), []);
    ...
    const evidenceSrc = useMemo(() => drawCanvas(1200, 120, '"the technique"', { x: 990, y: 40, w: 100, h: 28 }), []);
