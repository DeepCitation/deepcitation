...
const baseCitation = {
    ...
    sourceContext: "Bill 56 expands ministerial control over water approvals and related governance frameworks",
    pageNumber: 3,
};
...
async function expectWithinViewport(page, popover) {
...
async function expandToEvidence(page, popover) {
...
async function expandToFullPage(page, popover) {
...
test.describe("Summary — Right Edge", () => {
    test("trigger flush right — popover stays in bounds", async ({ mount, page, }) => {
        ...
        <CitationComponent citation={baseCitation} verification={verifiedVerification} pageImagesByAttachmentId={pageImages}/>
      </div>);
        const popover = await openPopover(page);
        await expectWithinViewport(page, popover);
    });
    test("trigger flush right on narrow viewport (480px)", async ({ mount, page, }) => {
    ...
    test("trigger flush right on tablet viewport (768px)", async ({ mount, page, }) => {
...
test.describe("Summary — Bottom Edge", () => {
    test("trigger near bottom — popover flips above", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "650px",
                paddingLeft: "200px",
            }}>
...
test.describe("Summary — Bottom-Right Corner", () => {
    test("trigger at bottom-right corner — popover stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "650px",
                display: "flex",
                justifyContent: "flex-end",
    ...
    test("trigger at bottom-right corner on narrow viewport (480px)", async ({ mount, page, }) => {
...
test.describe("Expanded-Evidence — Right Edge", () => {
    test("trigger flush right — expanded-evidence stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "200px",
                display: "flex",
                justifyContent: "flex-end",
    ...
    test("trigger flush right on narrow viewport — expanded-evidence stays in bounds", async ({ mount, page, }) => {
...
test.describe("Expanded-Evidence — Bottom Edge", () => {
    test("trigger near bottom — expanded-evidence stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "600px",
                paddingLeft: "200px",
            }}>
    ...
    test("trigger at bottom-right corner — expanded-evidence stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "600px",
                display: "flex",
                justifyContent: "flex-end",
...
test.describe("Expanded-Page — Right Edge", () => {
    test("trigger flush right — expanded-page stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "200px",
                display: "flex",
                justifyContent: "flex-end",
...
test.describe("Expanded-Page — Bottom Edge", () => {
    test("trigger near bottom — expanded-page stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{
                paddingTop: "600px",
                paddingLeft: "200px",
            }}>
...
test.describe("Centered Body Layout — Right Edge", () => {
    test("trigger at right edge of narrow centered container — popover stays in bounds", async ({ mount, page, }) => {
    ...
    test("trigger at right edge of narrow container on 600px viewport", async ({ mount, page, }) => {
        await page.setViewportSize({ width: 600, height: 720 });
        await mount(<div style={{
                maxWidth: "860px",
                margin: "0 auto",
    ...
    test("expanded-evidence at right edge of centered container", async ({ mount, page, }) => {
        await page.setViewportSize({ width: 600, height: 720 });
        await mount(<div style={{
                maxWidth: "860px",
                margin: "0 auto",
...
test.describe("Summary — Left Edge", () => {
    test("trigger flush left — popover stays in bounds", async ({ mount, page, }) => {
        await mount(<div style={{ paddingTop: "200px", paddingLeft: "4px" }}>
        <CitationComponent citation={baseCitation} verification={verifiedVerification} pageImagesByAttachmentId={pageImages}/>
      </div>);
        const popover = await openPopover(page);
        await expectWithinViewport(page, popover);
