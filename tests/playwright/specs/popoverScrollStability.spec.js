...
const testImage = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mO8cuXKfwAHggJ/PchI6QAAAABJRU5ErkJggg==";
const verification = {
    status: "found",
    attachmentId: "att-scroll-1",
...
test("popover scrolls with page content (position:absolute in scroll container)", async ({ mount, page }) => {
    ...
    await mount(<div id={scrollContainerId} style={{ height: "500px", overflow: "auto", position: "relative" }}>
      <div style={{ height: "3000px", padding: "100px 40px 40px" }}>
        <p style={{ marginBottom: "100px" }}>Scroll padding above</p>
        <CitationComponent citation={citation} verification={verification} pageImagesByAttachmentId={pageImagesByAttachmentId}/>
