...
import { UrlCitationComponent } from "../../../src/react/Citation";
// =============================================================================
// TEST FIXTURES
// =============================================================================
const verifiedUrlMeta = {
...
test.describe("URL Citation - Blocked Status", () => {
    ...
    test.skip("custom blocked indicator renders", async ({ mount, page }) => {
        await mount(<UrlCitationComponent urlMeta={blockedLoginMeta} renderBlockedIndicator={(status, _message) => <span data-testid="custom-blocked">Custom: {status}</span>}/>);
